...
//            .hostnameVerifier(dummyVerifier)
        ...
        val request = Request.Builder()
            .url(url)
//            .addHeader(SUB_PROTOCAL_HEADER_KEY, SUB_PROTOCAL_HEADER_VALUE)
            .build()
    ...
    override fun onOpen(webSocket: WebSocket, response: Response) {
        ...
        statePublisher.onNext(RxWebSocketState.Connected("Connected"))
    }
    ...
    override fun onClosed(webSocket: WebSocket, code: Int, reason: String) {
        ...
        statePublisher.onNext(RxWebSocketState.Disconnected("Connected"))
    }
    ...
    companion object {
        private val TAG = MyWebSocket::class.java.simpleName
    }
}
