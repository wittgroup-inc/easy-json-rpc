...
import com.wittgroupinc.easyjsonrpc.Runtime.Companion.getClient
import com.wittgroupinc.easyjsonrpc.Runtime.Companion.getSerializer
import io.reactivex.Single
import java.lang.reflect.*
import java.util.concurrent.atomic.AtomicLong

class EasyJsonRpc {
    private fun <T, B> createJsonRpcService(
        service: Class<T>,
